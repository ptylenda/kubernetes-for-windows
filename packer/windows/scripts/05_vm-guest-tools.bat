...
if exist "C:\Users\Administrator\windows.iso" (
    move /Y C:\Users\Administrator\windows.iso C:\Windows\Temp
)
...
if exist "C:\Users\Administrator\VBoxGuestAdditions.iso" (
    move /Y C:\Users\Administrator\VBoxGuestAdditions.iso C:\Windows\Temp
)
...
:parallels
if exist "C:\Users\Administrator\prl-tools-win.iso" (
	move /Y C:\Users\Administrator\prl-tools-win.iso C:\Windows\Temp
